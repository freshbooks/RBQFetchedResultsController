Pod::Spec.new do |s|
  ...
  s.homepage     = "http://github.com/freshbooks/RBQFetchedResultsController"
  s.license      = { :type => "MIT", :file => "LICENSE" }
  s.author       = { "Roobiq" => "support@roobiq.com" }
  s.social_media_url   = "http://twitter.com/Roobiq"
  s.platform     = :ios, "8.0"
  s.source       = { :git => "https://github.com/freshbooks/RBQFetchedResultsController.git", :tag => "v#{s.version}", :submodules => true }
  s.source_files  = [
